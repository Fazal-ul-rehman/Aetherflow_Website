      ...
      <div class="contact-left opacity-0 -translate-x-12">
        ...
        <ul class="mt-6 space-y-3 text-gray-700 dark:text-gray-300">
          <li class="flex items-center gap-3">
            <i class="fa-solid fa-envelope bg-gradient-to-r from-purple-700 to-pink-400 bg-clip-text text-transparent"></i>
            contact@aetherflow.pk
          </li>
          <li class="flex items-center gap-3">
            <i class="fa-solid fa-phone bg-gradient-to-r from-purple-700 to-pink-400 bg-clip-text text-transparent"></i>
            +923484473442
          </li>
          <li class="flex items-center gap-3">
            <i class="fa-solid fa-location-dot bg-gradient-to-r from-purple-700 to-pink-400 bg-clip-text text-transparent"></i>
...
onMounted(() => {
  ...
  document.querySelectorAll('.contact-left, .contact-form').forEach(el => observer.observe(el))
})
</script>
